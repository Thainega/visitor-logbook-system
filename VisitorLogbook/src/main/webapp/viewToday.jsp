...
<%
    ...
    List<Visitor> todayVisitors = (List<Visitor>) request.getAttribute("todayVisitors");
...
<div class="table-container">
    <h2><i class="bi bi-calendar-day"></i> Today's Visitors</h2>
    ...
    <!-- 🔎 Search Form -->
    <form method="get" action="ViewTodayServlet" class="search-box">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
            <%
                if (todayVisitors != null && !todayVisitors.isEmpty()) {
                    for (Visitor v : todayVisitors) {
            %>
                <tr>
                    <td><%= v.getName() %></td>
                    <td><%= v.getMobile() %></td>
                    ...
                    <td>
                        <a href="DeleteVisitorServlet?id=<%= v.getId() %>&source=today"
